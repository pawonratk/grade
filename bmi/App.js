...
export default class App extends React.Component {
  ...
  {
    const bmi= new BMI();
    const w = Number(this.state.weight);
    const h = Number(this.state.height);
    const r = this.state.region;
    var b = bmi.bmiCalculate(w,h);
    var j ='BMI = '+ b.toString() + '\n';
    const a = bmi.bmiClassification(b,r);
    Alert.alert(j+a);
  }
        ...
        <View style={{ flex: 1, marginTop: 50 }}>
          ...
          />
            <Picker
              ...
              <Picker.Item label="Westurn" value="westurn" />
            </Picker>
